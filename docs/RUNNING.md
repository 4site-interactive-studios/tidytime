...
**Describes commit `fb8ba7d` · 401 tests passing (`make test` regenerates) · 2026-08-28.**
...
| | | Produced by |
|---|---|---|
| **401 unit tests, 0 failures** | | `make test` |
| **64.75% line / 68.92% region coverage** on `Sources/` | measured 2026-08-28; the shortfall is SwiftUI + live-OS code that can't run headlessly | `make coverage` |
